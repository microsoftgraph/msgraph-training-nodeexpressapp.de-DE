# <a name="microsoft-graph-training-module---build-nodejs-express-apps-with-microsoft-graph"></a>Microsoft Graph Training Module – erstellen von Node. js Express-apps mit Microsoft Graph
